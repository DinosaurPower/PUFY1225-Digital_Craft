...
function draw() {
  ...
  gif_createImg.position(windowHeight/3, windowWidth/5); //I ad my gif and once it starts working I will set up its size and position
   gif_createImg.size(windowWidth/3, windowHeight/2.05);
  textSize(32);
