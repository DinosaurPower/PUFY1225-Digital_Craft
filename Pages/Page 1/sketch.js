...
function draw() {
  ...
  gif_createImg.position(windowHeight/2, windowWidth/2.5); //I ad my gif and once it starts working I will set up its size and position
   gif_createImg.size(windowWidth/1.3, windowHeight/2);
  textSize(32);
