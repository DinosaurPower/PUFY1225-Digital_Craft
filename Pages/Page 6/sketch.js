...
function preload() {
  ...
  png_createImg = createImg("Sprite6.png"); //I upload my gif
}
...
function draw() {
  ...
  png_createImg.mode (CENTER);
  png_createImg.position(windowHeight/2, windowWidth); //I ad my gif and once it starts working I will set up its size and position
